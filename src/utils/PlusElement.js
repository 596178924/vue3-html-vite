...
const LoadHandlerOptions = {
  spinner: LoadSvg,
  svgViewBox: svgViewBox,
  background: LoadBackground,
}
export const lockLoadHandler = (text = 'loading',  options = LoadHandlerOptions) => {
...
export const targetLoadHandler = (target, text = 'loading...', options = LoadHandlerOptions) => {
	return ElLoading.service({
		target,
		text,
		...options
